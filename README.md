...
3. 目标文件夹：
   - `D:\000\ai-whisper\` — 放 AI 程序 + 模型
   - `D:\000\mpv\` — mpv 播放器（已就绪）
...
> **说明：** 语音识别完成后，需要 AI 把字幕翻译成中文。智谱 AI 提供免费额度，注册即可使用。
...
> **注意：** 注册后会弹出一个弹窗，问你是「企业组织」还是「我是开发者」，这里选择 **「跳过」**。
...
## 第四步：配置 sub_fastwhisper.conf（核心步骤）
...
**Q2: 提示 "AI subtitle generation failed"？**
